...
::callout
This module and it's authors are in no way or form connected to the OpenID Foundation (OIDF). [Read disclaimer](#disclaimer)
::
...
Use minimal provider-specific setup guides when you just want a fast login flow:

- [GitHub Quickstart](/provider/github#quickstart)
- [Auth0 Setup Guide](/provider/auth0)
- [AWS Cognito Setup Guide](/provider/aws-cognito)
- [Entra ID Setup Guide](/provider/entra)
- [Keycloak Setup Guide](/provider/keycloak)
- [Microsoft Setup Guide](/provider/microsoft)

See all available entries in [Getting Started Providers](/getting-started/providers).
